...
import cookies from '../../common/utils/util.cookies'
export default {
  name: 'VBrrage',
  props: {
    // 弹幕源数组
  ...
  methods: {
    ...
    shootTopDanmu(dmItem, channel) {
      ...
      dom.style.transform = `translate3d(${this.barMainWidth / 2 -
        dom.clientWidth / 2}px,${channel * dom.clientHeight}px,0)`
