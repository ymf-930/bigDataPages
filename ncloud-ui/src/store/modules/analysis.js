...
export default {
  state: {
    ...
    // 贷款需求
    dkxq: [
      { name: 'xx市*****服务部', desc: '申请融资金额50万', date: '2022-05-13' },
      { name: 'xx市*****服务部', desc: '申请融资金额50万', date: '2022-05-13' },
      { name: 'xx市*****服务部', desc: '申请融资金额50万', date: '2022-05-13' },
      { name: 'xx市*****服务部', desc: '申请融资金额50万', date: '2022-05-13' },
      { name: 'xx市*****服务部', desc: '申请融资金额50万', date: '2022-05-13' }
    ...
    // 服务动态
    fwdt: [
      { name: '山东xx农村商业银行与xx市*****对接成功', date: '2022-05-13' },
      { name: '山东xx农村商业银行与xx市*****对接成功', date: '2022-05-13' },
      { name: '山东xx农村商业银行与xx市*****对接成功', date: '2022-05-13' },
      { name: '山东xx农村商业银行与xx市*****对接成功', date: '2022-05-13' },
      { name: '山东xx农村商业银行与xx市*****对接成功', date: '2022-05-13' }
    ...
    // 融资排行
    rzph: [
      { rank: '1', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '2', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '3', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '4', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '5', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '6', name: 'xx农商行', value: '1612312万', rate: 15 },
      { rank: '7', name: 'xx农商行', value: '1612312万', rate: 15 }
    ],
    // 方式分析
    fsfx: [
      {
