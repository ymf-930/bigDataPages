...
var uploadedDataURL = '../images/map/ds.json';

$.getJSON(uploadedDataURL, function (geoJson) {
  echarts.registerMap('砀山县', geoJson);
  var chinaGeoCoordMap = {
    '砀城镇': [116.352217,34.432632],
    '赵屯镇': [116.310403,34.428664],
    '李庄镇': [116.493258,34.395648],
    '唐寨镇': [116.606393,34.43556],
    '葛集镇': [116.526084,34.508809],
    '周寨镇': [116.459215,34.564606],
    '玄庙镇': [116.334705,34.535291],
    '官庄坝镇': [116.255837,34.525483],
    '曹庄镇': [116.210756,34.43065],
    '关帝庙镇': [116.397447,34.360487],
    '朱楼镇': [116.509548,34.31924],
    '良梨镇': [116.51433,34.43965],
    '程庄镇': [116.580333,34.344184],
    '砀山县': [116.372733, 34.447984]
  };
  var chinaDatas = [
    [{
      name: '砀城镇',
  ...
  var convertData = function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      var toCoord = [116.372733, 34.447984];
  ...
  var series = [];
  [['砀山县', chinaDatas]].forEach(function (item, i) {
    series.push({
        type: 'lines',
        zlevel: 2,
        effect: {
